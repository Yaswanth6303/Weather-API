const apiKey = "YOUR-API-KEY"; //Colllect API Key from OpenWeather Website
...
function displayCurrentWeather(data) {
    const date = new Date();
    const formattedDate = date.toLocaleDateString('en-IN', { weekday: 'long', year: 'numeric', month: 'numeric', day: 'numeric' });

    cityName.innerText = `${data.name} (${formattedDate})`;
    tempElement.innerHTML = `<img src="/Resources/thermometer1.png" alt="temp" width="25px" height="15px">Temperature: ${data.main.temp}°C`;
    windElement.innerHTML = `<img src="/Resources/wind.png" alt="wind" width="15px" height="15px">&nbsp;Wind: ${data.wind.speed} m/s`;
    humidityElement.innerHTML = `<img src="/Resources/humidity.png" alt="humidity" width="15px" height="15px">&nbsp;Humidity: ${data.main.humidity}%`;
...
function displayForecast(forecastList) {
    ...
    for (let i = -1; i < forecastList.length; i += 8) {
        ...
        forecastDiv.innerHTML = `
            ...
            <p><img src="/Resources/thermometer1.png" alt="temp" width="25px" height="15px">Temperature: ${forecast.main.temp}°C</p>
            <p><img src="/Resources/wind.png" alt="wind" width="15px" height="15px">&nbsp;Wind: ${forecast.wind.speed} m/s</p>
            <p><img src="/Resources/humidity.png" alt="humidity" width="15px" height="15px">&nbsp;Humidity: ${forecast.main.humidity}%</p>
        `;
